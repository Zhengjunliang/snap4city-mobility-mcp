...
Run **two processes** on the JupyterHub (see §11; public transport uses the online whatif-router, no third process needed). First the **local MCP server** that serves
