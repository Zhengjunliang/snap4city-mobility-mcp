...
Una variante \textbf{senza percorso} della stessa ricerca risponde a richieste come
\emph{``mostrami le farmacie qui intorno''}: attorno al centro --- la posizione GPS
oppure un indirizzo o una citt\`a indicati dall'utente --- vengono cercati fino a
cinquanta servizi della categoria richiesta e restituiti come soli \emph{pin} sulla
mappa, senza tracciare alcuna linea. Se manca la categoria o il luogo, l'advisor lo
chiede prima di procedere.
