...
% TODO Pass 3: Output (semplificato) da examples/S01-tre-modi.json
...
\subsection{S05 --- Chip ``Mostra tutte''}
\textbf{Situazione.} Ripristina la vista a tre rotte insieme e l'unione dei servizi.
\textbf{Riproduzione.} Dopo aver selezionato una singola chip (S02--S04), clic su
\emph{Mostra tutte}.
\textbf{Output:} vista lato client del payload di \texttt{examples/S01-tre-modi.json}.
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{S05-tre-modi-tutte.png}
  \caption{Ripristino della vista a tre modi.}
  \label{fig:S05}
\end{figure}
...
piedi''}.
% TODO Pass 3: Output (semplificato) da examples/S06-modo-singolo-piedi.json
...
auto''}.
% TODO Pass 3: Output (semplificato) da examples/S07-modo-singolo-auto.json
...
autobus''}.
% TODO Pass 3: Output (semplificato) da examples/S08-modo-singolo-autobus.json
...
% TODO Pass 3: Output (semplificato) da examples/S09-origine-gps.json
...
priorit\`a rispetto alla vicinanza all'ancora.
\textbf{Riproduzione.} L'utente digita \emph{``da via Roma 10 a Firenze a viale Morgagni
40''}.
% TODO Pass 3: Output (semplificato) da examples/S10-citta-nominata.json
...
% TODO Pass 3: Output (semplificato) da examples/S11-follow-up.json
...
pi\`u vicino''}.
% TODO Pass 3: Output (semplificato) da examples/S12-dest-categoria-supermercato.json
...
pi\`u vicina?''}.
% TODO Pass 3: Output (semplificato) da examples/S13-dest-categoria-farmacia.json
...
% TODO Pass 3: Output (semplificato) da examples/S14-servizi-percorso-ristoranti.json
...
% TODO Pass 3: Output (semplificato) da examples/S15-servizi-percorso-autobus.json
...
intorno''}.
% TODO Pass 3: Output (semplificato) da examples/S16-nearby-farmacie.json
...
% TODO Pass 3: Output (semplificato) da examples/S17-nearby-centro-nominato.json
...
qui vicino?''}.
% TODO Pass 3: Output (semplificato) da examples/S18-nearby-parcheggi.json
...
autobus alle 18''}.
% TODO Pass 3: Output (semplificato) da examples/S19-orario-partenza.json
...
% TODO Pass 3: Output (semplificato) da examples/S20-non-supportato.json
...
% TODO Pass 3: Output (semplificato) da examples/S21-chiarimento.json
...
\begin{table}[htbp]
  \centering
  % TODO Pass 3: sostituire i valori con quelli delle catture ricreate (examples/S01, S08, S14)
  \begin{tabular}{llrr}
    \toprule
    ...
    S01 --- Tre modi         & auto              & -- & -- \\
                             ...
                             & a piedi           & -- & -- \\
    \midrule
    S08 --- Autobus (tragitto pi\`u lungo)   & trasporto pubblico & -- & -- \\
    S14 --- Auto + servizi lungo il percorso & auto               & -- & -- \\
    \bottomrule
  \end{tabular}
